                        ...
                        <div class="card card-wrapper shadow dashboard-card h-100">
                            ...
                            <div class="card-body p-2">
                                ...
                                <div class="mt-3 d-flex gap-2">
                                    ...
                                    <form action="{{ route('head.ebooks.destroy', $ebook->id) }}" method="POST" class="flex-fill" onsubmit="return confirm('Are you sure you want to delete this e-book?');">
                                        @csrf
                                        @method('DELETE')
    ...
    <div class="modal fade" id="addEBookModal" tabindex="-1" aria-labelledby="addEBookModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form id="addNewEBookForm" action="{{ route('head.ebooks.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            editButtons.forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    document.getElementById('editEBookForm').action = '{{ route("head.ebooks.update", ":id") }}'.replace(':id', ebookId);
