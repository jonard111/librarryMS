                            ...
                            <div class="card card-wrapper shadow dashboard-card h-100">
                                ...
                                <div class="card-body p-2">
                                    ...
                                    <div class="mt-3 d-flex gap-2">
                                        ...
                                        <form action="{{ route('assistant.books.destroy', $book->id) }}" method="POST" class="flex-fill" onsubmit="return confirm('Are you sure you want to delete this book?');">
                                            @csrf
                                            @method('DELETE')
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            editButtons.forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    document.getElementById('editBookForm').action = '{{ route("assistant.books.update", ":id") }}'.replace(':id', bookId);
