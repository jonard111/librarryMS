...
<div class="sidebar">
    ...
    <nav class="nav flex-column text-start">
      ...
      <a href="{{ route('faculty.borrowed') }}" class="nav-link active">
                        ...
                        <tr>
                            ...
                            <td>
                              @if(in_array($request->status ?? '', ['pending', 'approved']))
                                <form action="{{ route('faculty.requests.cancel', $request->id) }}" method="POST" style="display: inline;" onsubmit="return confirm('Are you sure you want to cancel this request?');">
                                  @csrf
                                  @method('DELETE')
